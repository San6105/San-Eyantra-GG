...
Original file is located at
    https://colab.research.google.com/drive/1HJxgUJjcXabVXbdoKT8zuTRdlGVYYVSb
"""
...
# Team ID:			[ GG_1684]
# Author List:		[P.ANBUSELVAN,S.SARAVANAN,G.RASSWANTH,M.HILSTIENE ]
# Filename:			task_1a.py
...
def identify_features_and_targets(encoded_dataframe):
    target = pandas.DataFrame(encoded_dataframe.LeaveOrNot)
    features =pandas.DataFrame(encoded_dataframe.iloc[:,[0,1,2,3,4,5,6,7]])
...
def load_as_tensors(features_and_targets):
 ...
 # Use int64 for labels
    ...
    X_test_tensor = X[-num_validation:]
    y_test_tensor= y[-num_validation:]
    ...
    tensors_and_iterable_training_data = [X_train_tensor, y_train_tensor, X_test_tensor, y_test_tensor, train_loader, val_loader]
...
def training_function(model, number_of_epochs, tensors_and_iterable_training_data, loss_function, optimizer):
    train_loader= tensors_and_iterable_training_data[4]
     # Obtain the train_loader

    for epoch in range(number_of_epochs):
        trained_model=model.train()  # Set the model to training mode
        total_loss = 0.0
...
if __name__ == "__main__":
    ...
    task_1a_dataframe =pandas.read_csv(r'/content/task_1a_dataset1.csv')


    # Data preprocessing and obtaining encoded data
    encoded_dataframe = data_preprocessing(task_1a_dataframe)
    san=pandas.DataFrame(encoded_dataframe.iloc[:,[0,1,2,3,4,5,6,7]])
    print(san)
